...
CREATE TABLE `teams` (
  ...
  PRIMARY KEY (`team_id`),
  KEY `team_abbreviation_idx` (`team_abbreviation`),
  CONSTRAINT `team_abbreviation` FOREIGN KEY (`team_abbreviation`) REFERENCES `players` (`team_abbreviation`)
